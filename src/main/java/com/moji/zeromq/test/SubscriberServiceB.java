...
public class SubscriberServiceB {
	...
	public static void main(String[] args) {
		System.out.println(System.currentTimeMillis()+": B段计算开始...");
		Long start = System.currentTimeMillis();
		SubscriberServiceB.run();
		System.out.println(System.currentTimeMillis()+": B段计算结束...");
