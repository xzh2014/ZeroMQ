...
public class SubscriberServiceC {
	public static void run(){
		...
		System.out.println(System.currentTimeMillis()+": 计算任务任务开始...");
	...
	public static void main(String[] args) {
		System.out.println(System.currentTimeMillis()+": C段计算开始...");
		Long start = System.currentTimeMillis();
		SubscriberServiceC.run();
		System.out.println(System.currentTimeMillis()+": C段计算结束...");
